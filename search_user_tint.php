...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          ...
          <?php while ($tracking = mysqli_fetch_assoc($result)) { ?>
            ...
            <th scope="id"><?php echo $tracking['id']; ?></th>
              ...
              <td>TINT   
                    ...
                    <td>
                        <a href="tape_user_tint.php?id=<?php echo $tracking['id']; ?>" class="btn btn-success">TAPE_TEST</a>  
                </td>
                    <td>
                    <?php if ($tracking['resulttape'] == 'PASS') { ?>
                        <a href="steel_user_tint.php?id=<?php echo $tracking['id']; ?>" class="btn btn-success">STEEL_WOOL</a>
                        <?php } ?>
                    </td>
                    <td>
                   
                    <?php if ($tracking['resulttape'] == 'PASS') { ?>
                        <a href="boling_user_tint.php?id=<?php echo $tracking['id']; ?>" class="btn btn-success">BOILING_WATER</a>
                        <?php } ?>
                    </td>
                        
                    <?php if ($tracking['resulttape'] == 'PASS') { ?>
                        <a href="tint_user.php?id=<?php echo $tracking['id']; ?>" class="btn btn-success">TINT</a>
                        <?php } ?>
                    </td>
 ...
 <a href="user_tint.php" class="btn btn-success">กลับหน้าแรก</a>
