...
<?php 
    ...
    if (isset($_POST['submit'])) {
        ...
        $stmt = $conn->prepare("UPDATE tracking_tint SET  BatchGenQC = :BatchGenQC, roundtape = :roundtape, cx = :cx, cc = :cc, resulttape = :resulttape, testertape = :testertape WHERE id = :id ");
...
<body>
    <div class="container mt-5">
        ...
        <hr>
            <form action="tape_user_tint.php" method="post" enctype="multipart/form-data">
            <?php
            if (isset($_GET['id'])) {
                        $id = $_GET['id'];
