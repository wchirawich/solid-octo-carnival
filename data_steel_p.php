...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h2>DATA STEEL WOOL </h2>
        <div class="btn-toolbar mb-2 mb-md-0">
          <div class="btn-group me-3">
          </div>
          <form action="search_steel_p.php" class="form-group me-2" method="POST">
          <div class="row">
          <div class="col-9">
        ...
        <table class="table" align="center">
            ...
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h2>DATA STEEL WOOL TINT</h2>
        <div class="btn-toolbar mb-2 mb-md-0">
          <div class="btn-group me-3">
            
          </div>
          <form action="search_steel_tint.php" class="form-group me-2" method="POST">
          <div class="row">
          <div class="col-9">
          <input type="text" placeholder="" class="form-control" name="emp_data" required>
          </div>
