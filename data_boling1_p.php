...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3border-bottom">
        ...
        <h2>DATA BOILING WATER 1 TINT</h2>
        <div class="btn-toolbar mb-2 mb-md-0">
          <div class="btn-group me-3">
            
          </div>
          <form action="search_boiling1_tint_p.php" class="form-group me-2" method="POST">
          <div class="row">
          <div class="col-9">
          <input type="text" placeholder="" class="form-control" name="emp_data" required>
          </div>
  ...
  <ul class="pagination justify-content-end">
    <li class="page-item"><a class="page-link" href="data_boling2_p.php">CYCLE 2 </a></li>
  </ul>
</nav>
